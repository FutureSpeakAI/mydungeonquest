// THE DOOM GATE (Directive X, Laws VI–VII) — the sheet door (a standing
...
// The fall rule stands byte-stable in the prompt. Keyless, deterministic.
...
import { ROLE_TABLE, applyStateUpdates, foldDeathSave, heroRoll, sheetFor } from 'fatescript/rules';
...
console.log('PASS — the doom law: the sheet door, the role table, the sealed fold, the three-and-three walk, the grave, and the fall notes hold.');

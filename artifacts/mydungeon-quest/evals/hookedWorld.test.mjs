...
import { presenceOf, visitorsOf, partyOf, elsewhereOf } from '../src/lib/presence.js';
import { watchOf } from '../src/lib/calendar.js';
...
console.log('PASS — the hooked-world gate: one record, eight laws, no contradictions between the calendar, the ledger, the atlas, the briefing, the ground, the party, and the paint.');

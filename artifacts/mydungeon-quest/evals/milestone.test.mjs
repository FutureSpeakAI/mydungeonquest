// THE MILESTONE GATE (Directive XII §I, §VII.1) — the road makes you
// larger, and only the road. Levels 1..5 derive from the spine's standing
// beat alone: four thresholds by name (first beat of Act II, the
...
} from 'fatescript/rules';
import { applyPartyMilestone, applyStoryUpdates, initCodex } from 'fatescript/story';
...
console.log(`PASS — MILESTONE GATE: ${courts} courts sat, all green. The road makes you larger, and only the road.`);

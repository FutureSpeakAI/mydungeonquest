...
const foundry = new Foundry({ campaignId:'eval', tier:'illuminated', spend:{images:80,music:8} });
assert.equal(foundry.allowed('paint'), false); assert.equal(foundry.allowed('music'), false);

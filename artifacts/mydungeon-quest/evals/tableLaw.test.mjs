// ---- THE TABLE LAW (Task 58C — Directive XIV) ----
//
...
// plainly. Pure fold, zero tokens, keyless.
import assert from 'node:assert/strict';
import { readFileSync } from 'node:fs';
import { CHIP_ORDER, tableOf } from 'fatescript/table';
...
console.log('PASS — the table law: four chips, a closed set, honest words, the tracker bound to the flag alone');

// THE THREAD GATE — the narrative debt economy. Promises, debts,
// mysteries, and sworn goals are sealed operations: the validator rejects
// malformed or duplicate ledger writes, the reducer guards canon with
// notes, the story block tells the DM what the tale owes, and the pure
// replay cites the exact turn every promise was made.
...
console.log('PASS — the thread gate: the ledger is sealed operations, duplicates and false closings are refused at two layers, the DM is told what the tale owes, and every promise cites its turn.');

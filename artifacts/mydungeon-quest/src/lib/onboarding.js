// ------------------------------------------------------------
// THE THREE SPARKS — onboarding as law. The distance from opening the app
// to hearing the first sentence of YOUR OWN world is three choices or
// fewer: a spark, a voice, begin. Sparks are dealt deterministically from
// the forge's own pools, so the gate can prove the deal.
// ------------------------------------------------------------

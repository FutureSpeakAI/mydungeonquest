...
export const EDITOR_ADDENDUM = `THE HOUSE VOICE ADDENDUM (Directive XVII, Article V). The pre-pass flags are deterministic law, not taste. A 'dash' flag is MANDATORY REVISE: zero em dashes may ship; name the dash law among your reasons and direct each dash to a comma, a period, or a rebuilt sentence. A 'tells' flag means language-model tells crowd the page past the pinned density; direct replacements in the house craft: concrete nouns, active verbs, the senses before the summary, sentence music varied. THE MEASURE LAW (Directive XI, Law V): the assigned measure sets word count and paragraph count in lockstep — lean requires 40-90 words in 1-2 paragraphs, standard requires 90-200 words in 3-5 paragraphs, rich requires 200-360 words in 6-8 paragraphs; with no beat_intent the range is 60-160 words. An 'under-measure' or 'over-measure' flag is revise: expand or compress to land inside the band.`;

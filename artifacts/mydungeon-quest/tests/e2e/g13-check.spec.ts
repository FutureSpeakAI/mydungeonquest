...
const PINNED_PASS_COUNT = 162; // Task 65 Phase 8 (Directive XX, Law VIII): +1 — the kinship gate joins the keyless check in the same commit that builds the immunity; 161 → 162

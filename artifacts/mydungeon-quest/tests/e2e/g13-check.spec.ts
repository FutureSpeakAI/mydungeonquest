...
const PINNED_PASS_COUNT = 165; // Task 65 Phase 11 (Directive XX, Law XII): +1 — the pyre-and-parcel gate joins the keyless check in the same commit that raises the owner's two rights; 164 → 165

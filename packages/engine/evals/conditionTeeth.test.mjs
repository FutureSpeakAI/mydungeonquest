// THE CONDITION-TEETH GATE (engine twin, pure fraction) — wounds with
...
// cause. Keyless, deterministic, no browser. The game addresses
// 'fatescript/rules' and 'fatescript/story' directly (engine seats
// '../src/rules.js', '../src/story.js'); its compat seat
// '../src/lib/protocol.js' is a shim over 'fatescript/protocol', read
// here from its true home '../src/protocol.js'.
import assert from 'node:assert/strict';
import { CONDITIONS, companionRoll, createHero, heroRoll, sheetFor } from '../src/rules.js';
...
console.log(`PASS — CONDITION-TEETH GATE (engine twin, pure fraction): ${courts} courts sat, all green. One table, one engine, two lawful actors.`);

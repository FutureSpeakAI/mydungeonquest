...
import { bearingFor, bearingBlock, paintRoster } from '../bearing.js';
import { cardsForCampaign } from '../cards.js';
import { UNLETTERED_WORLD } from '../unlettered.js';
import { calendarOf, watchOf } from '../calendar.js';
import { yearsSinceTurn } from '../clock.js';
...
// hand presumes the signature is still worn. Seated home with the parity
// cut: the easel's whole voice is the engine's.
...
// owned by the engine (./unlettered.js) and shared with the warden

...
export function mockDmTurn({ campaign, hero, story, player, entropy, resolution, turn = 0 }) {
  ...
  return {
    ...
    time_advance: first ? { unit: 'hours', n: 1 } : turn === 4 ? { unit: 'hours', n: 2 } : null,
    entropy_use: []
  };
}
